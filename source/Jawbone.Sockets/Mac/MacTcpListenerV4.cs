...
sealed class MacTcpListenerV4 : ITcpListener<IpAddressV4>
{
    ...
    public static MacTcpListenerV4 Listen(
        ...
        SocketOptions socketOptions)
    {
        ...
        try
        {
            ...
            return new MacTcpListenerV4(fd, socketOptions);
        }
        catch
        {
            _ = Sys.Close(fd);
